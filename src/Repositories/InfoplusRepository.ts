    ...
    public async getCurrentRealtimeTripUpdates(operationDate: string): Promise<IDatabaseRitInfoUpdate[]> {
        return this.database.raw(`
            ...
            FROM "InfoPlus".ritinfo r
                     ...
                     JOIN "InfoPlus".stop_information si ON jpjl."logicalJourneyPartNumber" = si."logicalJourneyPartNumber" AND jpjl."operationDate" = si."operationDate" AND "plannedWillStop" = true AND ("plannedDepartureTime" != "actualDepartureTime" OR "plannedArrivalTime" != "actualArrivalTime")
